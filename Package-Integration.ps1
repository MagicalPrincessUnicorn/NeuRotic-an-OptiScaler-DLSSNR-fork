...
$stage = Join-Path $root 'release\NeuRotic-approved-integration'
...
$record = [ordered]@{ kind='integration experiment; not a release'; branch=$manifest.branch; commit=$commit;
